                    ...
                    <div id="c_1" class="card border shadow-0 mb-g shadow-sm-hover" data-filter-tags="oliver kopyov">
                        <div class="card-body border-faded border-top-0 border-left-0 border-right-0 rounded-top">
                            <div class="d-flex flex-row align-items-center">
                                <span class="status <?php echo "status-".$user["status"]; ?> mr-3">
                                ...
                                <div class="info-card-text flex-1">
                                    <a href="javascript:void(0);" class="fs-xl text-truncate text-truncate-lg text-info" data-toggle="dropdown" aria-expanded="false">
                                        ...
                                        <?php if (is_admin()||is_that_user($user['id'])):?>
                                    ...
                                    <div class="dropdown-menu">
                                        <a class="dropdown-item" href=<?php echo "edit.php?id=".$user['id'];?>>
                                            <i class="fa fa-edit"></i>
                                        Редактировать</a>
                                        <a class="dropdown-item" href=<?php echo "security.php?id=".$user['id'];?>>
                                            <i class="fa fa-lock"></i>
                                        Безопасность</a>
                                        <a class="dropdown-item" href=<?php echo "status.php?id=".$user['id'];?>>
                                            <i class="fa fa-sun"></i>
                                        Установить статус</a>
                                        <a class="dropdown-item" href=<?php echo "media.php?id=".$user['id'];?>>
                                            <i class="fa fa-camera"></i>
                                            Загрузить аватар
                                        </a>
                                        <a href=<?php echo "delete.php?id=".$user['id']; ?> class="dropdown-item" onclick="return confirm('are you sure?');">
