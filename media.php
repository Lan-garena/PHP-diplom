...
<body>
    ...
    <main id="js-page-content" role="main" class="page-content mt-3">
        ...
        <form action=<?php echo "media_handler.php?id=".$_GET["id"]; ?> method="post" enctype="multipart/form-data">
            <div class="row">
                <div class="col-xl-6">
                        ...
                        <div class="panel-container">
                            ...
                            <div class="panel-content">
                                <div class="form-group">
                                    <img src="<?php echo $location["image"]; ?>" alt="" class="img-responsive" width="200">
                                </div>
