...
$user = get_user_info_by_id($_SESSION["user"]["id"]);
 ?>
                        ...
                        <div class="row no-gutters row-grid">
                            ...
                            <div class="col-12">
                                <div class="p-3 text-center">
                                    <a href=<?php echo "tel:".$user["phone"];?> class="mt-1 d-block fs-sm fw-400 text-dark">
                                        <i class="fas fa-mobile-alt text-muted mr-2"></i> <?php echo $user["phone"];?></a>
                                    <a href=<?php echo "mailto:".$user["email"];?> class="mt-1 d-block fs-sm fw-400 text-dark">
